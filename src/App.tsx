        ...
        <CartProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/apple" element={<div className="pt-16 p-8 text-center"><h1 className="text-2xl font-bold">Apple Store - En construcción</h1></div>} />
              <Route path="/electronica" element={<div className="pt-16 p-8 text-center"><h1 className="text-2xl font-bold">Electrónica Premium - En construcción</h1></div>} />
